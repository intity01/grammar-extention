...
console.log('Note: For production, convert these to PNG using an image editor or online tool.');
console.log('Or install sharp: npm install sharp, and use it to convert SVG to PNG.');
