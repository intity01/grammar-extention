...
// Summary
console.log('\n' + '='.repeat(60));
console.log(`📊 Summary: ${completedCount}/${totalRequired} required items completed`);
...
if (allValid) {
  ...
  console.log('  2. Generate missing icons using promotional/icons/PNG-GENERATION.md');
  console.log('  3. Create promotional images from promotional/images/generate-promo-images.html');
  console.log('  4. Capture screenshots using promotional/screenshots/GUIDE.md');
