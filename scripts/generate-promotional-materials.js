...
console.log('\nNext steps:');
console.log('1. Generate PNG icons from SVG (see promotional/icons/INSTRUCTIONS.md)');
console.log('2. Create promotional images (see promotional/images/templates.html)');
console.log('3. Capture screenshots (see promotional/screenshots/GUIDE.md)');
console.log('4. Open promotional/screenshots/test-page.html in browser to test extension');
