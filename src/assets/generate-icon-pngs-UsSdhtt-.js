...
console.log(
  "1. Convert SVG icons to PNG using one of the methods in promotional/icons/PNG-GENERATION.md",
);
console.log("2. The SVG files are ready in promotional/icons/");
console.log(
  "3. For quick conversion, use: https://cloudconvert.com/svg-to-png",
);
