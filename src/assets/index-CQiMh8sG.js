!(function () {
  ...
  function b(b) {
    return (function (e) {
      ...
      : (function (e) {
            ...
            return (s >= a.start && s <= a.end) || (s >= t.start && s <= t.end);
          })(b)
        ? e.ENGLISH
        : (function (e) {
              const s = e.charCodeAt(0);
  ...
  const i = new (class {
    ...
    async init() {
      if (!this.db)
        return (
          this.initPromise ||
            (this.initPromise = new Promise((e, s) => {
              const a = indexedDB.open("GrammarCheckerDB", 1);
              ((a.onerror = () => {
                s(new Error(`Failed to open IndexedDB: ${a.error}`));
              }),
                (a.onsuccess = () => {
                  ((this.db = a.result), e());
                }),
                (a.onupgradeneeded = (e) => {
                  ...
                  if (!s.objectStoreNames.contains(c)) {
                    const e = s.createObjectStore(c, { keyPath: "language" });
    ...
    async storeDictionary(e) {
      return (
        ...
        new Promise((s, a) => {
          ...
          ((t.onsuccess = () => s()),
            (t.onerror = () =>
              a(new Error(`Failed to store dictionary: ${t.error}`))));
        })
      );
    }
      ...
      return (
        ...
        new Promise((s, a) => {
          ...
          ((t.onsuccess = () => {
            ...
            (t.onerror = () =>
              a(new Error(`Failed to load dictionary: ${t.error}`))));
        })
      );
    }
    ...
    async getDictionaryMetadata(e) {
      const s = await this.loadDictionary(e);
    ...
    async deleteDictionary(e) {
      return (
        ...
        new Promise((s, a) => {
          ...
          ((t.onsuccess = () => s()),
            (t.onerror = () =>
              a(new Error(`Failed to delete dictionary: ${t.error}`))));
        })
      );
    }
    async listDictionaries() {
      return (
        ...
        new Promise((e, s) => {
          ...
          ((a.onsuccess = () => {
            const s = a.result;
            e(s.map((e) => e.metadata));
          }),
            (a.onerror = () =>
              s(new Error(`Failed to list dictionaries: ${a.error}`))));
        })
      );
    }
    async clearAll() {
      return (
        ...
        new Promise((e, s) => {
          ...
          ((a.onsuccess = () => e()),
            (a.onerror = () =>
              s(new Error(`Failed to clear dictionaries: ${a.error}`))));
        })
      );
    }
    close() {
  ...
  function l() {
    return (
      (null === o ||
        !0 === o.buffer.detached ||
        (void 0 === o.buffer.detached && o.buffer !== g.memory.buffer)) &&
    ...
    return (function (e, s) {
      ((j += s),
        j >= x &&
          ...
          y.decode(),
          (j = s)));
      return y.decode(w().subarray(e, e + s));
    })((e >>>= 0), s);
  }
  let f = null;
  function w() {
    return (
      (null !== f && 0 !== f.byteLength) ||
        (f = new Uint8Array(g.memory.buffer)),
      f
    );
  }
  function p(e) {
  ...
  function q(e, s, a) {
    ...
    let m = 0;
    for (; m < t; m++) {
      const s = e.charCodeAt(m);
      if (s > 127) break;
      d[r + m] = s;
    }
    if (m !== t) {
      (0 !== m && (e = e.slice(m)),
        (r = a(r, t, (t = m + 3 * e.length), 1) >>> 0));
      const s = w().subarray(r + m, r + t);
      ((m += v.encodeInto(e, s).written), (r = a(r, t, m, 1) >>> 0));
    }
    return ((z = m), r);
  }
  function k(e) {
  ...
  "encodeInto" in v ||
    (v.encodeInto = function (e, s) {
      const a = v.encode(e);
      return (s.set(a), { read: e.length, written: a.length });
    });
  let z = 0;
  "undefined" == typeof FinalizationRegistry ||
    new FinalizationRegistry((e) => g.__wbg_dictionary_free(e >>> 0, 1));
  const D =
    "undefined" == typeof FinalizationRegistry
      ? { register: () => {}, unregister: () => {} }
      : new FinalizationRegistry((e) =>
          g.__wbg_dictionarymanager_free(e >>> 0, 1),
        );
  class C {
    __destroy_into_raw() {
    ...
    free() {
      ...
      g.__wbg_dictionarymanager_free(e, 0);
    }
    lookupWord(e, s) {
      const a = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
        t = z,
        r = q(s, g.__wbindgen_export3, g.__wbindgen_export4),
        d = z,
        m = g.dictionarymanager_lookupWord(this.__wbg_ptr, a, t, r, d);
      return 4294967297 === m ? void 0 : m;
    }
    matchRules(e, s) {
      try {
        const r = g.__wbindgen_add_to_stack_pointer(-16),
          d = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
          m = z,
          b = q(s, g.__wbindgen_export3, g.__wbindgen_export4),
          c = z;
        g.dictionarymanager_matchRules(r, this.__wbg_ptr, d, m, b, c);
        var a = l().getInt32(r + 0, !0),
          t = l().getInt32(r + 4, !0);
    ...
    containsWord(e, s) {
      const a = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
        ...
        r = q(s, g.__wbindgen_export3, g.__wbindgen_export4),
        d = z;
      return 0 !== g.dictionarymanager_containsWord(this.__wbg_ptr, a, t, r, d);
    }
    tokenizeThai(e) {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16),
          r = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
          d = z;
        g.dictionarymanager_tokenizeThai(t, this.__wbg_ptr, r, d);
        var s = l().getInt32(t + 0, !0),
          a = l().getInt32(t + 4, !0);
        if (l().getInt32(t + 8, !0)) throw k(a);
        return k(s);
      } finally {
        g.__wbindgen_add_to_stack_pointer(16);
      }
    ...
    loadDictionary(e, s) {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16),
          ...
          d = z,
          m = (function (e, s) {
            const a = s(1 * e.length, 1) >>> 0;
            return (w().set(e, a / 1), (z = e.length), a);
          })(s, g.__wbindgen_export3),
          b = z;
        g.dictionarymanager_loadDictionary(t, this.__wbg_ptr, r, d, m, b);
        var a = l().getInt32(t + 0, !0);
        if (l().getInt32(t + 4, !0)) throw k(a);
      } finally {
        g.__wbindgen_add_to_stack_pointer(16);
      }
    }
    tokenizeEnglish(e) {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16),
          r = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
          d = z;
        g.dictionarymanager_tokenizeEnglish(t, this.__wbg_ptr, r, d);
        var s = l().getInt32(t + 0, !0),
          a = l().getInt32(t + 4, !0);
        if (l().getInt32(t + 8, !0)) throw k(a);
        return k(s);
    ...
    hasGrammarRules(e) {
      const s = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
        a = z;
      return 0 !== g.dictionarymanager_hasGrammarRules(this.__wbg_ptr, s, a);
    }
    tokenizeJapanese(e) {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16),
          r = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
          d = z;
        g.dictionarymanager_tokenizeJapanese(t, this.__wbg_ptr, r, d);
        var s = l().getInt32(t + 0, !0),
          a = l().getInt32(t + 4, !0);
        if (l().getInt32(t + 8, !0)) throw k(a);
        return k(s);
    ...
    unloadDictionary(e) {
      const s = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
        a = z;
      return 0 !== g.dictionarymanager_unloadDictionary(this.__wbg_ptr, s, a);
    }
    loadGrammarRules(e, s) {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16),
          r = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
          d = z,
          m = q(s, g.__wbindgen_export3, g.__wbindgen_export4),
          b = z;
        g.dictionarymanager_loadGrammarRules(t, this.__wbg_ptr, r, d, m, b);
        var a = l().getInt32(t + 0, !0);
        if (l().getInt32(t + 4, !0)) throw k(a);
      } finally {
        g.__wbindgen_add_to_stack_pointer(16);
    ...
    getLoadedLanguages() {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16);
        g.dictionarymanager_getLoadedLanguages(t, this.__wbg_ptr);
        var e = l().getInt32(t + 0, !0),
          ...
          a = (function (e, s) {
            ...
            const a = l(),
              t = [];
            for (let r = e; r < e + 4 * s; r += 4)
              t.push(k(a.getUint32(r, !0)));
            return t;
          })(e, s).slice();
        return (g.__wbindgen_export(e, 4 * s, 4), a);
      } finally {
        g.__wbindgen_add_to_stack_pointer(16);
      }
    }
    tokenizeThaiGreedy(e) {
      try {
        const t = g.__wbindgen_add_to_stack_pointer(-16),
          r = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
          d = z;
        g.dictionarymanager_tokenizeThaiGreedy(t, this.__wbg_ptr, r, d);
        var s = l().getInt32(t + 0, !0),
          a = l().getInt32(t + 4, !0);
        if (l().getInt32(t + 8, !0)) throw k(a);
        return k(s);
    ...
    getTotalMemoryUsage() {
      return g.dictionarymanager_getTotalMemoryUsage(this.__wbg_ptr) >>> 0;
    }
    constructor() {
      const e = g.dictionarymanager_new();
      return (
        (this.__wbg_ptr = e >>> 0),
    ...
    analyze(e, s) {
      try {
        const r = g.__wbindgen_add_to_stack_pointer(-16),
          ...
          b = q(s, g.__wbindgen_export3, g.__wbindgen_export4),
          c = z;
        g.dictionarymanager_analyze(r, this.__wbg_ptr, d, m, b, c);
        var a = l().getInt32(r + 0, !0),
          t = l().getInt32(r + 4, !0);
        if (l().getInt32(r + 8, !0)) throw k(t);
        return k(a);
    ...
    isLoaded(e) {
      const s = q(e, g.__wbindgen_export3, g.__wbindgen_export4),
        a = z;
      return 0 !== g.dictionarymanager_isLoaded(this.__wbg_ptr, s, a);
    }
  }
  Symbol.dispose && (C.prototype[Symbol.dispose] = C.prototype.free);
  const B = new Set(["basic", "cors", "default"]);
  function E() {
    const e = { wbg: {} };
    return (
      (e.wbg.__wbg___wbindgen_throw_dd24417ed36fc46e = function (e, s) {
        throw new Error(u(e, s));
      }),
      (e.wbg.__wbg_error_7534b8e9a36f1ab4 = function (e, s) {
        let a, t;
        try {
          ((a = e), (t = s));
        } finally {
          g.__wbindgen_export(a, t, 1);
        }
      }),
      (e.wbg.__wbg_log_a720b8e551fa05a3 = function (e, s) {}),
      ...
      (e.wbg.__wbg_push_7d9be8f38fc13975 = function (e, s) {
        return p(e).push(p(s));
      }),
      (e.wbg.__wbg_set_781438a03c0c3c81 = function () {
        return (function (e, s) {
          try {
            ...
            g.__wbindgen_export2(n(a));
          }
        })(function (e, s, a) {
          return Reflect.set(p(e), p(s), p(a));
        }, arguments);
      }),
      (e.wbg.__wbg_stack_0ed75d68575b0f3c = function (e, s) {
        const a = q(p(s).stack, g.__wbindgen_export3, g.__wbindgen_export4),
          t = z;
        (l().setInt32(e + 4, t, !0), l().setInt32(e + 0, a, !0));
      }),
      (e.wbg.__wbg_warn_6e567d0d926ff881 = function (e) {}),
      (e.wbg.__wbindgen_cast_2241b6af4c4b2941 = function (e, s) {
        return n(u(e, s));
      }),
  ...
  async function T(e) {
    ...
    ("string" == typeof e ||
      ...
      (e = fetch(e));
    const { instance: a, module: t } = await (async function (e, s) {
      if ("function" == typeof Response && e instanceof Response) {
        ...
        return await WebAssembly.instantiate(t, s);
      }
      {
        const a = await WebAssembly.instantiate(e, s);
  ...
  const R = new Set(),
    M = new Set();
  async function I(e) {
    if (!A) throw new Error("Dictionary manager not initialized");
    if (!R.has(e))
      try {
        const s = await (async function (e) {
          const s = await i.loadDictionary(e);
          return s ? s.data : null;
        })(e);
        if (!s) throw new Error(`Dictionary data not found for ${e}`);
        const a = new Uint8Array(s);
        (A.loadDictionary(e, a), R.add(e));
      } catch (s) {
        throw s;
      }
  }
    ...
    if (!M.has(e))
      try {
        const s = `rules/${e}.json`,
          a = new URL(
            Object.assign({
              ...
              "../../SUBMISSION-GUIDE.md":
                "/assets/SUBMISSION-GUIDE-V98J9SyF.md",
              ...
              "../../dist/assets/BUILD_SUMMARY-av14ka4Q.md":
                "/assets/BUILD_SUMMARY-av14ka4Q.md",
              "../../dist/assets/CACHEDIR-X40RTQvV-X40RTQvV.TAG":
                "/assets/CACHEDIR-X40RTQvV.TAG",
              "../../dist/assets/CACHEDIR-X40RTQvV.TAG":
                "/assets/CACHEDIR-X40RTQvV.TAG",
              "../../dist/assets/CHECKLIST-6Mc1Sgbn.md":
                "/assets/CHECKLIST-6Mc1Sgbn.md",
              "../../dist/assets/CHROME-WEB-STORE-CCleLTU3.txt":
                "/assets/CHROME-WEB-STORE-CCleLTU3.txt",
              "../../dist/assets/CHROME_TESTING_GUIDE-DVbUXipj.md":
                "/assets/CHROME_TESTING_GUIDE-DVbUXipj.md",
              "../../dist/assets/CROSS_BROWSER_TESTING_COMPARISON-Bwe9uNwK.md":
                "/assets/CROSS_BROWSER_TESTING_COMPARISON-Bwe9uNwK.md",
              "../../dist/assets/Cargo-LJQ9YRsu.toml":
                "/assets/Cargo-LJQ9YRsu.toml",
              "../../dist/assets/EDGE-ADD-ONS-DFUPWxhy.txt":
                "/assets/EDGE-ADD-ONS-DFUPWxhy.txt",
              "../../dist/assets/EDGE_TESTING_CHECKLIST-TVN3inHw.md":
                "/assets/EDGE_TESTING_CHECKLIST-TVN3inHw.md",
              "../../dist/assets/EDGE_TESTING_GUIDE-DxEk-QEp.md":
                "/assets/EDGE_TESTING_GUIDE-DxEk-QEp.md",
              "../../dist/assets/EDGE_TESTING_README-Dqbi1Xmc.md":
                "/assets/EDGE_TESTING_README-Dqbi1Xmc.md",
              "../../dist/assets/GETTING-STARTED-BX4SRFlA.md":
                "/assets/GETTING-STARTED-BX4SRFlA.md",
              "../../dist/assets/GITHUB-PAGES-SETUP-shhsjwDu.md":
                "/assets/GITHUB-PAGES-SETUP-shhsjwDu.md",
              "../../dist/assets/GUIDE-BvupQsJI.md":
                "/assets/GUIDE-BvupQsJI.md",
              "../../dist/assets/IMPLEMENTATION_SUMMARY-BQv6fbBq.md":
                "/assets/IMPLEMENTATION_SUMMARY-BQv6fbBq.md",
              "../../dist/assets/IMPROVEMENTS_SUMMARY-TA3ZFKWn.md":
                "/assets/IMPROVEMENTS_SUMMARY-TA3ZFKWn.md",
              "../../dist/assets/INSTRUCTIONS-DFnO7bEf.md":
                "/assets/INSTRUCTIONS-DFnO7bEf.md",
              "../../dist/assets/MONITORING-25zv5457.md":
                "/assets/MONITORING-25zv5457.md",
              "../../dist/assets/PACKAGING-GUIDE-CbSIh8ZX.md":
                "/assets/PACKAGING-GUIDE-CbSIh8ZX.md",
              "../../dist/assets/PNG-GENERATION-BeCYUKoD.md":
                "/assets/PNG-GENERATION-BeCYUKoD.md",
              "../../dist/assets/PRIVACY-Da3aw5cn.md":
                "/assets/PRIVACY-Da3aw5cn.md",
              "../../dist/assets/PROMOTIONAL-MATERIALS-SETUP-CS8LAHqG.md":
                "/assets/PROMOTIONAL-MATERIALS-SETUP-CS8LAHqG.md",
              "../../dist/assets/PUBLISHING-COMPLETE-SUMMARY-Cdt_R6uj.md":
                "/assets/PUBLISHING-COMPLETE-SUMMARY-Cdt_R6uj.md",
              "../../dist/assets/README-BPWwFcJx.md":
                "/assets/README-BPWwFcJx.md",
              "../../dist/assets/README-BWctAnce.md":
                "/assets/README-BWctAnce.md",
              "../../dist/assets/README-Bj0CibJk.md":
                "/assets/README-Bj0CibJk.md",
              "../../dist/assets/README-BzmwvnbN.md":
                "/assets/README-BzmwvnbN.md",
              ...
              "../../dist/assets/README-G0lotEOo.md":
                "/assets/README-G0lotEOo.md",
              "../../dist/assets/RELEASE-NOTES-C7kwEOHg.md":
                "/assets/RELEASE-NOTES-C7kwEOHg.md",
              "../../dist/assets/RULE_MATCHER_IMPLEMENTATION-oGLDmdDJ.md":
                "/assets/RULE_MATCHER_IMPLEMENTATION-oGLDmdDJ.md",
              "../../dist/assets/SETUP-DR8o1mZH.md":
                "/assets/SETUP-DR8o1mZH.md",
              "../../dist/assets/STORE-LISTING-CznphES4.md":
                "/assets/STORE-LISTING-CznphES4.md",
              "../../dist/assets/SUBMISSION-GUIDE-V98J9SyF.md":
                "/assets/SUBMISSION-GUIDE-V98J9SyF.md",
              "../../dist/assets/TASK-1-SUMMARY-CAkx4hKg.md":
                "/assets/TASK-1-SUMMARY-CAkx4hKg.md",
              "../../dist/assets/TASK-2-COMPLETION-SUMMARY-DYy6oeTv.md":
                "/assets/TASK-2-COMPLETION-SUMMARY-DYy6oeTv.md",
              "../../dist/assets/TASK_16.3_SUMMARY-B8DUB_ji.md":
                "/assets/TASK_16.3_SUMMARY-B8DUB_ji.md",
              "../../dist/assets/TASK_16.4_COMPLETION_SUMMARY-BVL5jQ8C.md":
                "/assets/TASK_16.4_COMPLETION_SUMMARY-BVL5jQ8C.md",
              "../../dist/assets/TASK_16.4_SUMMARY-0gS83ZTy.md":
                "/assets/TASK_16.4_SUMMARY-0gS83ZTy.md",
              "../../dist/assets/TESTING_CHECKLIST-uj6qf2jl.md":
                "/assets/TESTING_CHECKLIST-uj6qf2jl.md",
              "../../dist/assets/TESTING_GUIDE-O4U6lgav.md":
                "/assets/TESTING_GUIDE-O4U6lgav.md",
              "../../dist/assets/VERIFICATION_REPORT-DHLLJGRZ.md":
                "/assets/VERIFICATION_REPORT-DHLLJGRZ.md",
              "../../dist/assets/_config-DodJEsfR.yml":
                "/assets/_config-DodJEsfR.yml",
              "../../dist/assets/analysisPerformanceBound.property.test-DcmJg2He-DcmJg2He.ts":
                "/assets/analysisPerformanceBound.property.test-DcmJg2He.ts",
              "../../dist/assets/analysisPerformanceBound.property.test-DcmJg2He.ts":
                "/assets/analysisPerformanceBound.property.test-DcmJg2He.ts",
              "../../dist/assets/background-BFJi8Xma.js":
                "/assets/background-BFJi8Xma-BFJi8Xma.js",
              "../../dist/assets/build-BGC7rL85.sh":
                "/assets/build-BGC7rL85.sh",
              "../../dist/assets/build-BeusINUB.sh":
                "/assets/build-BeusINUB.sh",
              "../../dist/assets/build-KjPZge3V.ps1":
                "/assets/build-KjPZge3V.ps1",
              "../../dist/assets/build-N34CftXu-N34CftXu.ps1":
                "/assets/build-N34CftXu-N34CftXu-N34CftXu.ps1",
              "../../dist/assets/build-rRym2s_I.ps1":
                "/assets/build-rRym2s_I.ps1",
              "../../dist/assets/clipboardModeNonModification.property.test-Bt_tKos4-Bt_tKos4.ts":
              ...
              "../../dist/assets/clipboardModeNonModification.property.test-Bt_tKos4.ts":
                "/assets/clipboardModeNonModification.property.test-Bt_tKos4.ts",
              "../../dist/assets/content-5WmDGja_.js":
                "/assets/content-5WmDGja_-5WmDGja_.js",
              "../../dist/assets/contenteditable.spec-Bz_5YeMN.ts":
                "/assets/contenteditable.spec-Bz_5YeMN.ts",
              "../../dist/assets/correctionAvailability.property.test-BS5l5ExC-BS5l5ExC.ts":
              ...
              "../../dist/assets/cursorPositionAdjustment.property.test-CSuwHhj2-CSuwHhj2.ts":
                "/assets/cursorPositionAdjustment.property.test-CSuwHhj2.ts",
              "../../dist/assets/cursorPositionAdjustment.property.test-CSuwHhj2.ts":
                "/assets/cursorPositionAdjustment.property.test-CSuwHhj2.ts",
              "../../dist/assets/darling_macro-f2e480840b7b6132.dll-qF0dpKmE-qF0dpKmE.exp":
                "/assets/darling_macro-f2e480840b7b6132.dll-qF0dpKmE.exp",
              "../../dist/assets/darling_macro-f2e480840b7b6132.dll-qF0dpKmE.exp":
                "/assets/darling_macro-f2e480840b7b6132.dll-qF0dpKmE.exp",
              "../../dist/assets/dat-thxSOgp_-thxSOgp_.rs":
                "/assets/dat-thxSOgp_.rs",
              "../../dist/assets/dat-thxSOgp_.rs": "/assets/dat-thxSOgp_.rs",
              "../../dist/assets/debouncedInput.property.test-D-c_Azqz-D-c_Azqz.ts":
                "/assets/debouncedInput.property.test-D-c_Azqz.ts",
              "../../dist/assets/debouncedInput.property.test-D-c_Azqz.ts":
                "/assets/debouncedInput.property.test-D-c_Azqz.ts",
              "../../dist/assets/derive_builder_macro-8cdff8121dfe173a.dll-CFAIHC8m-CFAIHC8m.exp":
              ...
              "../../dist/assets/dictionaryStorage.test-cW3ha_A5-cW3ha_A5.ts":
                "/assets/dictionaryStorage.test-cW3ha_A5.ts",
              "../../dist/assets/dictionaryStorage.test-cW3ha_A5.ts":
                "/assets/dictionaryStorage.test-cW3ha_A5.ts",
              "../../dist/assets/displaydoc-29d3556630e2351f.dll-DBZQifE_-DBZQifE_.exp":
              ...
              "../../dist/assets/english.dat-BQ49Dxx2.br":
                "/assets/english.dat-BQ49Dxx2.br",
              "../../dist/assets/english_tokenizer-C-4ZmXRT-C-4ZmXRT.rs":
                "/assets/english_tokenizer-C-4ZmXRT.rs",
              "../../dist/assets/english_tokenizer-C-4ZmXRT.rs":
                "/assets/english_tokenizer-C-4ZmXRT.rs",
              "../../dist/assets/errorDetection.property.test-BaeQL5gM-BaeQL5gM.ts":
                "/assets/errorDetection.property.test-BaeQL5gM.ts",
              "../../dist/assets/errorDetection.property.test-BaeQL5gM.ts":
                "/assets/errorDetection.property.test-BaeQL5gM.ts",
              "../../dist/assets/errorHighlighting.property.test-CS22XJzC-CS22XJzC.ts":
                "/assets/errorHighlighting.property.test-CS22XJzC.ts",
              "../../dist/assets/errorHighlighting.property.test-CS22XJzC.ts":
                "/assets/errorHighlighting.property.test-CS22XJzC.ts",
              "../../dist/assets/errorMonitoring-DDioBK2z.ts":
                "/assets/errorMonitoring-DDioBK2z.ts",
              "../../dist/assets/extension-basic.spec-DErVkiKb.ts":
                "/assets/extension-basic.spec-DErVkiKb.ts",
              "../../dist/assets/generate-icon-pngs-UsSdhtt-.js":
                "/assets/generate-icon-pngs-UsSdhtt-.js",
              "../../dist/assets/generate-icons-DyL3vH5W.js":
                "/assets/generate-icons-DyL3vH5W.js",
              "../../dist/assets/generate-promo-images-bo_JhDuE.html":
                "/assets/generate-promo-images-bo_JhDuE.html",
              "../../dist/assets/generate-promotional-materials-BPxmqd90.js":
                "/assets/generate-promotional-materials-BPxmqd90.js",
              "../../dist/assets/grammarEngine-D2aEG8zz-D2aEG8zz.ts":
                "/assets/grammarEngine-D2aEG8zz-D2aEG8zz-D2aEG8zz.ts",
              "../../dist/assets/grammarEngine-DBeEWBFJ.ts":
                "/assets/grammarEngine-DBeEWBFJ.ts",
              "../../dist/assets/grammarRules-B06Txb-D.ts":
                "/assets/grammarRules-B06Txb-D.ts",
              "../../dist/assets/grammarRules.test-BZ6kJG6f-BZ6kJG6f.ts":
                "/assets/grammarRules.test-BZ6kJG6f.ts",
              "../../dist/assets/grammarRules.test-BZ6kJG6f.ts":
                "/assets/grammarRules.test-BZ6kJG6f.ts",
              "../../dist/assets/grammarRulesIntegration.test-CsKxaHzJ-CsKxaHzJ.ts":
              ...
              "../../dist/assets/grammar_checker_wasm-CcxELTg8-CcxELTg8.wasm":
              ...
              "../../dist/assets/grammar_checker_wasm.dll-B2DUpPnY-B2DUpPnY.exp":
              ...
              "../../dist/assets/icon128-VWvLf8s0.png":
                "/assets/icon128-VWvLf8s0.png",
              "../../dist/assets/icon16-BbqD909L.svg":
                "/assets/icon16-BbqD909L.svg",
              "../../dist/assets/icon16-DjcbXTly.png":
                "/assets/icon16-DjcbXTly.png",
              "../../dist/assets/icon48-BJ-nHcOC.png":
                "/assets/icon48-BJ-nHcOC.png",
              "../../dist/assets/icon48-yflGKPyk.svg":
                "/assets/icon48-yflGKPyk.svg",
              "../../dist/assets/index-BDabRV4d.html":
                "/assets/index-BDabRV4d.html",
              "../../dist/assets/index-BUTWZvoL-BUTWZvoL.ts":
                "/assets/index-BUTWZvoL-BUTWZvoL-BUTWZvoL.ts",
              "../../dist/assets/index-BqeyIMl0.ts":
                "/assets/index-BqeyIMl0.ts",
              "../../dist/assets/index-CLhzxKPn.ts":
                "/assets/index-CLhzxKPn.ts",
              "../../dist/assets/index-DJIDTDW9-Pz6Q2qUC.js":
                "/assets/index-DJIDTDW9-Pz6Q2qUC-Pz6Q2qUC.js",
              "../../dist/assets/index-DZY0Q9Kp.ts":
                "/assets/index-DZY0Q9Kp.ts",
              "../../dist/assets/index-nDGzFGjB-nDGzFGjB.ts":
                "/assets/index-nDGzFGjB-nDGzFGjB-nDGzFGjB.ts",
              "../../dist/assets/index-srflSMRx.js":
                "/assets/index-srflSMRx-DG8kNakW.js",
              "../../dist/assets/inlineCorrectionApplication.property.test-o4pKctDS-o4pKctDS.ts":
              ...
              "../../dist/assets/inlineCorrectionApplication.property.test-o4pKctDS.ts":
                "/assets/inlineCorrectionApplication.property.test-o4pKctDS.ts",
              "../../dist/assets/inputMonitor-Be7WH-5k-Be7WH-5k.ts":
                "/assets/inputMonitor-Be7WH-5k-Be7WH-5k-Be7WH-5k.ts",
              "../../dist/assets/inputMonitor-DT69X0pL.ts":
                "/assets/inputMonitor-DT69X0pL.ts",
              "../../dist/assets/inputMonitor.test-YtRZ0kdN-YtRZ0kdN.ts":
                "/assets/inputMonitor.test-YtRZ0kdN.ts",
              "../../dist/assets/inputMonitor.test-YtRZ0kdN.ts":
                "/assets/inputMonitor.test-YtRZ0kdN.ts",
              "../../dist/assets/invoked-DTC6oEyi-DTC6oEyi.timestamp":
              ...
              "../../dist/assets/japanese.dat-CefuXIyP.br":
                "/assets/japanese.dat-CefuXIyP.br",
              "../../dist/assets/japanese_tokenizer-DOQ8XLpa-DOQ8XLpa.rs":
                "/assets/japanese_tokenizer-DOQ8XLpa.rs",
              "../../dist/assets/japanese_tokenizer-DOQ8XLpa.rs":
                "/assets/japanese_tokenizer-DOQ8XLpa.rs",
              "../../dist/assets/jest.config-6OBBLFGB.ts":
                "/assets/jest.config-6OBBLFGB.ts",
              "../../dist/assets/jest.config-hRRfyfm0-hRRfyfm0.ts":
                "/assets/jest.config-hRRfyfm0-hRRfyfm0-hRRfyfm0.ts",
              "../../dist/assets/languageDetection.property.test-p99UlKmB-p99UlKmB.ts":
              ...
              "../../dist/assets/languageDetector.test-DRRI5SNt-DRRI5SNt.ts":
                "/assets/languageDetector.test-DRRI5SNt.ts",
              "../../dist/assets/languageDetector.test-DRRI5SNt.ts":
                "/assets/languageDetector.test-DRRI5SNt.ts",
              "../../dist/assets/languageSpecificRules.property.test-ugzUj-ML-ugzUj-ML.ts":
                "/assets/languageSpecificRules.property.test-ugzUj-ML.ts",
              "../../dist/assets/languageSpecificRules.property.test-ugzUj-ML.ts":
                "/assets/languageSpecificRules.property.test-ugzUj-ML.ts",
              "../../dist/assets/lazyDictionaryLoading.property.test-DDl2v_sA-DDl2v_sA.ts":
                "/assets/lazyDictionaryLoading.property.test-DDl2v_sA.ts",
              "../../dist/assets/lazyDictionaryLoading.property.test-DDl2v_sA.ts":
                "/assets/lazyDictionaryLoading.property.test-DDl2v_sA.ts",
              "../../dist/assets/lib-CvHB7tsy-CvHB7tsy.rs":
                "/assets/lib-CvHB7tsy.rs",
              "../../dist/assets/lib-CvHB7tsy.rs": "/assets/lib-CvHB7tsy.rs",
              "../../dist/assets/localProcessing.property.test-DB1Jetcp-DB1Jetcp.ts":
              ...
              "../../dist/assets/marquee-1400x560-f4M-V8mE.png":
                "/assets/marquee-1400x560-f4M-V8mE.png",
              "../../dist/assets/networkMonitor-8UuYGbPS.ts":
                "/assets/networkMonitor-8UuYGbPS.ts",
              "../../dist/assets/nonBlockingExecution.property.test-CY_10OTd-CY_10OTd.ts":
              ...
              "../../dist/assets/offscreen-pFjgFTaO.js":
                "/assets/offscreen-pFjgFTaO.js",
              "../../dist/assets/offscreen.test-CPU7eigV-CPU7eigV.ts":
                "/assets/offscreen.test-CPU7eigV-CPU7eigV-CPU7eigV.ts",
              "../../dist/assets/offscreen.test-DZr1BdTg.ts":
                "/assets/offscreen.test-DZr1BdTg.ts",
              ...
              "../../dist/assets/package-A0dejXOJ.json":
                "/assets/package-A0dejXOJ.json",
              "../../dist/assets/package-BVeeocf7.json":
                "/assets/package-BVeeocf7.json",
              "../../dist/assets/package-CV-spVlh-CV-spVlh.json":
                "/assets/package-CV-spVlh-CV-spVlh-CV-spVlh.json",
              "../../dist/assets/package-extension-DVRoe53D.js":
                "/assets/package-extension-DVRoe53D.js",
              "../../dist/assets/performanceMonitoring-CmQFoZNt.ts":
                "/assets/performanceMonitoring-CmQFoZNt.ts",
              "../../dist/assets/playwright.config-5O1Z5weA.ts":
                "/assets/playwright.config-5O1Z5weA.ts",
              "../../dist/assets/popup-CDfKaBqD.js":
                "/assets/popup-CDfKaBqD.js",
              "../../dist/assets/popup-DK-zJ_EA.html":
                "/assets/popup-DK-zJ_EA.html",
              "../../dist/assets/post-build-Bni0ZwR-.ps1":
                "/assets/post-build-Bni0ZwR-.ps1",
              "../../dist/assets/private-BznCm50K-BznCm50K.rs":
                "/assets/private-BznCm50K.rs",
              "../../dist/assets/private-BznCm50K.rs":
                "/assets/private-BznCm50K.rs",
              "../../dist/assets/private-DFt3thLc-DFt3thLc.rs":
                "/assets/private-DFt3thLc.rs",
              "../../dist/assets/private-DFt3thLc.rs":
                "/assets/private-DFt3thLc.rs",
              "../../dist/assets/reAnalysisTriggers.property.test-BuMooW0U-BuMooW0U.ts":
              ...
              "../../dist/assets/thai_tokenizer-qiWcMNpN-qiWcMNpN.rs":
                "/assets/thai_tokenizer-qiWcMNpN.rs",
              "../../dist/assets/thai_tokenizer-qiWcMNpN.rs":
                "/assets/thai_tokenizer-qiWcMNpN.rs",
              "../../dist/assets/thiserror_impl-53af2045af51ec31.dll-CJtlJPAx-CJtlJPAx.exp":
              ...
              "../../dist/assets/types-CMmEAllL.ts":
                "/assets/types-CMmEAllL.ts",
              "../../dist/assets/types-Dj0sbxz3-Dj0sbxz3.ts":
                "/assets/types-Dj0sbxz3-Dj0sbxz3-Dj0sbxz3.ts",
              "../../dist/assets/uiController-BTykno64-BTykno64.ts":
                "/assets/uiController-BTykno64-BTykno64-BTykno64.ts",
              "../../dist/assets/uiController-BdLIa2Qs.ts":
                "/assets/uiController-BdLIa2Qs.ts",
              "../../dist/assets/validate-promotional-materials-DhodeZk7.js":
                "/assets/validate-promotional-materials-DhodeZk7.js",
              "../../dist/assets/verify-build-C34AMXVf.js":
                "/assets/verify-build-C34AMXVf.js",
              "../../dist/assets/version-CeLiEO4u-CeLiEO4u.expr":
              ...
              "../../dist/assets/wasm.test-CqqjS-RM.ts":
                "/assets/wasm.test-CqqjS-RM.ts",
              "../../dist/assets/wasmPerformance.property.test-BfLUngCr-BfLUngCr.ts":
                "/assets/wasmPerformance.property.test-BfLUngCr.ts",
              "../../dist/assets/wasmPerformance.property.test-BfLUngCr.ts":
                "/assets/wasmPerformance.property.test-BfLUngCr.ts",
              "../../dist/assets/wasm_bindgen_macro-492f9f03b6397ea2.dll-Bm0Yd_CB-Bm0Yd_CB.exp":
              ...
              "../../dist/assets/wasm_bindgen_macro-492f9f03b6397ea2.dll-Bm0Yd_CB.exp":
                "/assets/wasm_bindgen_macro-492f9f03b6397ea2.dll-Bm0Yd_CB.exp",
              "../../dist/assets/wasm_bindgen_macro-8e677acf3b5744e0.dll-Bg0PGf_a-Bg0PGf_a.exp":
              ...
              "../../dist/assets/wasm_bindgen_macro-8e677acf3b5744e0.dll-Bg0PGf_a.exp":
                "/assets/wasm_bindgen_macro-8e677acf3b5744e0.dll-Bg0PGf_a.exp",
              "../../dist/assets/wasm_bindgen_macro-c41ecf66c81af1cd.dll-CAODwPvZ-CAODwPvZ.exp":
              ...
              "../../dist/assets/wasm_bindgen_macro-c41ecf66c81af1cd.dll-CAODwPvZ.exp":
                "/assets/wasm_bindgen_macro-c41ecf66c81af1cd.dll-CAODwPvZ.exp",
              "../../dist/assets/webWorkerNonBlocking.property.test-DslJ28TK-DslJ28TK.ts":
                "/assets/webWorkerNonBlocking.property.test-DslJ28TK-DslJ28TK-DslJ28TK.ts",
              "../../dist/assets/webWorkerNonBlocking.property.test-DyFv17i1.ts":
                "/assets/webWorkerNonBlocking.property.test-DyFv17i1.ts",
              "../../dist/assets/worker-CurGLgHQ.js":
                "/assets/worker-CurGLgHQ-CurGLgHQ.js",
              "../../dist/assets/yoke_derive-234b7ef35df9cd5e.dll-GKMoaUl5-GKMoaUl5.exp":
                "/assets/yoke_derive-234b7ef35df9cd5e.dll-GKMoaUl5.exp",
              "../../dist/assets/yoke_derive-234b7ef35df9cd5e.dll-GKMoaUl5.exp":
                "/assets/yoke_derive-234b7ef35df9cd5e.dll-GKMoaUl5.exp",
              "../../dist/assets/zerofrom_derive-914c0dcae04e6bfa.dll-jTEZGTwg-jTEZGTwg.exp":
                "/assets/zerofrom_derive-914c0dcae04e6bfa.dll-jTEZGTwg.exp",
              "../../dist/assets/zerofrom_derive-914c0dcae04e6bfa.dll-jTEZGTwg.exp":
                "/assets/zerofrom_derive-914c0dcae04e6bfa.dll-jTEZGTwg.exp",
              "../../dist/assets/zerovec_derive-3dc96371fb2c1df5.dll-Cp_dSTl_-Cp_dSTl_.exp":
                "/assets/zerovec_derive-3dc96371fb2c1df5.dll-Cp_dSTl_.exp",
              "../../dist/assets/zerovec_derive-3dc96371fb2c1df5.dll-Cp_dSTl_.exp":
                "/assets/zerovec_derive-3dc96371fb2c1df5.dll-Cp_dSTl_.exp",
              "../../dist/background.js": "/assets/background-c72lKsFM.js",
              "../../dist/chunks/dictionaryStorage-7TWGKNbx.js":
                "/assets/dictionaryStorage-7TWGKNbx-Btzg8BPX.js",
              "../../dist/chunks/telemetry-LsNYD_7L.js":
                "/assets/telemetry-LsNYD_7L-DN5IAqnj.js",
              "../../dist/content.js": "/assets/content-BB4o8mtp.js",
              ...
              "../../dist/dictionaries/thai.dat.br":
                "/assets/thai.dat-BrSIwSpv.br",
              "../../dist/excluded/Cargo.lock": "/assets/Cargo-BEd28hID.lock",
              "../../dist/excluded/pnpm-lock.yaml":
                "/assets/pnpm-lock-C3FQrOWp.yaml",
              "../../dist/excluded/pnpm-lock2.yaml":
                "/assets/pnpm-lock-CfCdrfg2.yaml",
              ...
              "../../dist/wasm/grammar_checker_wasm_bg.wasm":
                "/assets/grammar_checker_wasm_bg-DU_5VvBI.wasm",
              "../../dist/worker.js": "/assets/worker-Cx8OagWC.js",
              ...
              "../../playwright.config.ts":
                "/assets/playwright.config-5O1Z5weA.ts",
              "../../pnpm-lock.yaml": "/assets/pnpm-lock-CfCdrfg2.yaml",
              ...
              "../../promotional/icons/icon128.svg":
                "/assets/icon128-Br3fDnC9.svg",
              "../../promotional/icons/icon16.png":
                "/assets/icon16-DjcbXTly.png",
              "../../promotional/icons/icon16.svg":
                "/assets/icon16-BbqD909L.svg",
              "../../promotional/icons/icon48.png":
                "/assets/icon48-BJ-nHcOC.png",
              "../../promotional/icons/icon48.svg":
                "/assets/icon48-yflGKPyk.svg",
              ...
              "../../tests/e2e/contenteditable.spec.ts":
                "/assets/contenteditable.spec-Bz_5YeMN.ts",
              "../../tests/e2e/extension-basic.spec.ts":
                "/assets/extension-basic.spec-DErVkiKb.ts",
              ...
              "../../tests/unit/setup.test.ts":
                "/assets/setup.test-B_MLvxmA.ts",
              "../../tests/unit/wasm.test.ts": "/assets/wasm.test-CqqjS-RM.ts",
        ...
        if (
          ...
          throw new Error(`Invalid URL scheme for rules: ${a.href}`);
        const t = await fetch(a);
        if (!t.ok) throw new Error(`Failed to fetch rules: ${t.statusText}`);
        const r = await t.text();
        (A.loadGrammarRules(e, r), M.add(e));
      } catch (s) {
        throw s;
      }
  }
    ...
    try {
      ...
      if (0 === r.length)
        return {
          ...
          corrections: [],
          segments: [],
          processingTime: performance.now() - a,
        };
      for (const e of r) (R.has(e) || (await I(e)), M.has(e) || (await G(e)));
      const d = (function (e) {
      ...
      for (const e of d)
        if ("unknown" !== e.language)
          try {
            const a = A.analyze(e.text, e.language);
            if (a && a.errors) {
              const t = a.errors.map((s) => ({
                start: s.start + e.start,
                end: s.end + e.start,
                type: s.type || "grammar",
                message: s.message || "Grammar error detected",
                language: e.language,
              ...
              for (let e = 0; e < t.length; e++) {
                const r = t[e],
                  ...
                  m = {
                    error: r,
                    original: s.substring(r.start, r.end),
                    corrected: d.correction || s.substring(r.start, r.end),
                    confidence: 0.9,
                  };
                c.push(m);
              }
      ...
      switch (
        ...
        case "ANALYZE": {
          const { text: a } = e.payload,
            t = 10,
            r = 50 + Math.ceil(a.length / 1e3) * t,
            d = new Promise((e, s) => {
              setTimeout(() => s(new Error("Analysis timeout")), r);
            });
          try {
            return {
              type: "ANALYSIS_RESULT",
              payload: await Promise.race([U(a), d]),
              id: e.id,
            };
          } catch (s) {
            if (s instanceof Error && "Analysis timeout" === s.message)
              return {
                type: "ANALYSIS_RESULT",
                payload: {
                  errors: [],
        ...
        case "LOAD_DICTIONARY": {
          const { language: s } = e.payload;
          return (
            await I(s),
            { type: "DICTIONARY_LOADED", payload: { language: s }, id: e.id }
          );
        }
        case "LOAD_RULES": {
          const { language: s } = e.payload;
          return (
            await G(s),
            { type: "RULES_LOADED", payload: { language: s }, id: e.id }
          );
        }
        case "UNLOAD_DICTIONARY": {
          const { language: s } = e.payload;
          return (
            A && (A.unloadDictionary(s), R.delete(s), M.delete(s)),
            {
              type: "STATUS",
              payload: { message: `Dictionary unloaded for ${s}` },
              id: e.id,
            }
          );
        }
        case "GET_STATUS":
          return {
            ...
            payload: {
              initialized: S,
              loadedDictionaries: Array.from(R),
              loadedRules: Array.from(M),
              memoryUsage: A?.getTotalMemoryUsage() || 0,
            },
            id: e.id,
          };
        default:
